...
| ------------------------------------------ | ---------- | ------- | ------ | ----------------------- | ------------ | ------------------------------- | --------------------------------------------------------- |
| **`training_data_triangle_v1.bin`**            | 23,585,629 | 9,421   | May 27 | **bun/Triangle ✓ accurate** | X/X+         | **CANONICAL baseline** (current)    | **YES** - `modal_app.py` / `policy_value_pipeline.py` policy-value artifact validation |
...
- `triangle_v1` ∩ `data/replays-legacy` = **0** ; `data/replays-x-xplus` ∩ `data/replays-legacy` = **0** → the two replay folders are disjoint collections.
...
- `training_data_triangle_v1.bin` (+ sidecars) - `modal_app.py` / `policy_value_pipeline.py` policy-value artifact paths, `combine_canonical_supplement.py`, `scripts/modal_app.py`.
...
- `training/scripts/modal_app.py` still defaults several `replay_dir` parameters to `data/replays`; pass `data/replays-x-xplus/` explicitly for canonical baseline jobs.
